...
/**
 * Creates function to Testee data of multiply {@link bunching} function result invokes
 ...
 * @return {function(): Promise} function to set chunk of data  to process bunchly
 * @example
 * let timer;
 * const invoke = Testee(
